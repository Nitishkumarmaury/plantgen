...
const colorMap = {
  brand: { bg: "bg-brand-50", bgHover: "group-hover:bg-brand-100", icon: "text-brand-600", border: "border-brand-100" },
  coral: { bg: "bg-coral-50", bgHover: "group-hover:bg-coral-100", icon: "text-coral-500", border: "border-coral-100" },
  warm:  { bg: "bg-warm-50",  bgHover: "group-hover:bg-warm-100",  icon: "text-warm-600",  border: "border-warm-100" },
  teal:  { bg: "bg-teal-50",  bgHover: "group-hover:bg-teal-100",  icon: "text-teal-600",  border: "border-teal-100" },
};
          ...
          {features.map((feature) => {
            ...
            return (
              <StaggerItem key={feature.title}>
                <div className={`text-center group p-6 bg-white rounded-2xl border ${colors.border} hover:shadow-lg hover:-translate-y-1 transition-all duration-300`}>
                  <div className={`inline-flex items-center justify-center w-12 h-12 mb-5 ${colors.bg} rounded-xl ${colors.bgHover} transition-colors`}>
